...
export default class Container extends Component {
  ...
  getDragonTreasure() {
    ...
    .then(treasure =>
      this.setState({...this.state.treasures, dragon: treasure.data
    })
    ).catch(err => console.log(err))
  }

  getAllTreasure() {
    axios.get(`/api/treasure/all`).then(this.setState({treasure:{...this.state.treasures, all: treasure.data}})).catch(err =>
